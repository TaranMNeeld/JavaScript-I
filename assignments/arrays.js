...
const findCar = function (carNum) {
    for (let i = 0; i < inventory.length; i++) {
        let car = inventory[i];
        if (car.id === carNum) {
            return "Car " + carNum + " is a " + car.car_year + " " + car.car_make + " " + car.car_model;
        }
    }
...
const findAllCarYears = function() {
    for (let i = 0; i < inventory.length; i++) {
        let car = inventory[i];
